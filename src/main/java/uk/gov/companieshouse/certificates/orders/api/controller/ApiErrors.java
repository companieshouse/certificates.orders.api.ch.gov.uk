...
final class ApiErrors {
    ...
    static final ApiError ERR_COMPANY_STATUS_INVALID = new ApiError(COMPANY_STATUS_INVALID_ERROR, COMPANY_STATUS_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
