...
public final class ApiErrors {
    ...
    private static final String DESCRIPTION_VALUES_SUPPLIED_ERROR = "description-values-supplied-error";
    private static final String ETAG_SUPPLIED_ERROR = "etag-supplied-error";
    private static final String ITEM_COSTS_SUPPLIED_ERROR = "item-costs-supplied-error";
    private static final String KIND_SUPPLIED_ERROR = "kind-supplied-error";
    private static final String QUANTITY_AMOUNT_ERROR = "quantity-amount-error";
    ...
    private static final String DIRECTOR_DETAILS_INCLUDE_DOB_TYPE_LOCATION = "director_details.include_dob_type_error";
    ...
    private static final String SECRETARY_DETAILS_INCLUDE_DOB_TYPE_LOCATION = "secretary_details.include_dob_type_error";
    ...
    public static final ApiError ERR_DESCRIPTION_VALUES_SUPPLIED = new ApiError(DESCRIPTION_VALUES_SUPPLIED_ERROR, DESCRIPTION_VALUES_SUPPLIED_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_ETAG_SUPPLIED = new ApiError(ETAG_SUPPLIED_ERROR, ETAG_SUPPLIED_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    ...
    public static final ApiError ERR_KIND_SUPPLIED_LOCATION = new ApiError(KIND_SUPPLIED_ERROR, KIND_SUPPLIED_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_QUANTITY_AMOUNT = new ApiError(QUANTITY_AMOUNT_ERROR, QUANTITY_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_DESCRIPTION_IDENTIFIER = new ApiError(DESCRIPTION_IDENTIFIER_ERROR, DESCRIPTION_IDENTIFIER_LOCATION, STRING_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_POSTAL_DELIVERY = new ApiError(POSTAL_DELIVERY_ERROR, POSTAL_DELIVERY_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    ...
    public static final ApiError ERR_DIRECTOR_DETAILS_INCLUDE_NATIONALITY_ERROR = new ApiError(INCLUDE_NATIONALITY_ERROR, DIRECTOR_DETAILS_INCLUDE_NATIONALITY_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_DIRECTOR_DETAILS_INCLUDE_OCCUPATION_ERROR = new ApiError(INCLUDE_OCCUPATION_ERROR, DIRECTOR_DETAILS_INCLUDE_OCCUPATION_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    ...
    public static final ApiError ERR_SECRETARY_DETAILS_INCLUDE_NATIONALITY_ERROR = new ApiError(INCLUDE_NATIONALITY_ERROR, SECRETARY_DETAILS_INCLUDE_NATIONALITY_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    public static final ApiError ERR_SECRETARY_DETAILS_INCLUDE_OCCUPATION_ERROR = new ApiError(INCLUDE_OCCUPATION_ERROR, SECRETARY_DETAILS_INCLUDE_OCCUPATION_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
