...
public final class ApiErrors {
    ...
    public static final ApiError ERR_DIRECTOR_DETAILS_INCLUDE_DOB_TYPE_SUPPLIED_ERROR = new ApiError(INCLUDE_DOB_TYPE_REQUIRED_ERROR, DIRECTOR_DETAILS_INCLUDE_DOB_TYPE_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
    ...
    public static final ApiError ERR_SECRETARY_DETAILS_INCLUDE_DOB_TYPE_SUPPLIED_ERROR = new ApiError(INCLUDE_DOB_TYPE_REQUIRED_ERROR, SECRETARY_DETAILS_INCLUDE_DOB_TYPE_LOCATION, BOOLEAN_LOCATION_TYPE, ERROR_TYPE_VALIDATION);
