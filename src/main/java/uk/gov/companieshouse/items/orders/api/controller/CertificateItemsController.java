...
public class CertificateItemsController {
    ...
    public ResponseEntity<Object> getCertificateItem(@PathVariable String certificate_id)
    {
        Optional<CertificateItem> item = service.getCertificateItemById(certificate_id);
        if(item.isPresent()) {
